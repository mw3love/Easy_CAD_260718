...
- **Phase 6(편집 경험 현대화 UI/UX) 진행 중** — M1~M5 완료(툴바→QToolBar, 다크모드, 플로팅
  ...
  최신 항목: 대량 선택 O(n²) 캐스케이드 제거, 다중선택 그룹 크기조절 튐 수정, 스마트 정렬 가이드
  교차축 게이트 제거(2026-08-01/02, `docs/history/2026-08.md` 참조).
- **다음 순서**: `docs/EasyCAD_계획.md` §8("다음 순서"·"큰 설계 필요") 참조 — 화살표
  boundingRect 체인 후속 최적화, 실도면 대규모 성능 등.
