...
└── test_part1~6_*.py       테마별 회귀 스모크 373종(개별 pytest 실행 가능)
docs/
...
- **실제 도면 기반 신규 안건(§8 항목12~15, 2026-08-03 deep-interview)** — KBS 송신소 실제
  ...
  365종, `docs/history/2026-08.md` 참조). 항목13(안테나 심플화)·14(PDF 메뉴 통합)·
  15(AI 이미지→도면)는 세부 스코프 미정 — 착수 시 deep-interview.
...
- **다음 순서**: §8 항목13~15(안테나·PDF 메뉴·AI 이미지) + 기존 "다음 순서"·"큰 설계 필요"
